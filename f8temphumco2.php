...
<div class="f8-temphumco2-page-container">

<div id="TEMPHUMCO2_F8_OPEN_DONG" style="position: absolute; left: 50px; top: 240px;width: 130px; height: 100px; background-color: rgb(198,122,15);">
	...
	<table style="width: 100%;">
		<tr>
			...
			<td id="TEMPHUMCO2_F8_OPEN_DONG_TEMP" align="center" style="color: white">23.5</td>
			<td align="left">℃</td>
		</tr>
		<tr>
			<td align="right">湿度:</td>
			<td id="TEMPHUMCO2_F8_OPEN_DONG_HUM" align="center" style="color: white">23.6</td>
			<td align="left">RH</td>
		</tr>
		<tr>
...
<div id="TEMPHUMCO2_F8_OPEN_XI" style="position: absolute; left: 1040px; top: 240px;width: 130px; height: 100px; background-color: rgb(198,122,15);">
	<div style="width: 100%; height: 30px; color: white; background-color: rgb(114,66,10); padding-top: 5px;">西开敞办公区</div>
	<table style="width: 100%;">
		<tr>
			<td align="right">温度:</td>
			<td id="TEMPHUMCO2_F8_OPEN_XI_TEMP" align="center" style="color: white">23.5</td>
			<td align="left">℃</td>
		</tr>
		<tr>
			<td align="right">湿度:</td>
			<td id="TEMPHUMCO2_F8_OPEN_XI_HUM" align="center" style="color: white">23.6</td>
			<td align="left">RH</td>
		</tr>
		<tr>
			<td align="right">浓度:</td>
...
<div id="TEMPHUMCO2_F8_SUOZHANGSHI3_DONG" style="position: absolute; left: 250px; top: 30px;width: 100px; height: 85px; background-color: rgb(198,122,15);">
	...
	<table style="width: 100%; font-size: 12px">
		<tr>
			<td align="right">温度:</td>
			<td id="TEMPHUMCO2_F8_SUOZHANGSHI3_DONG_TEMP" align="center" style="color: white">23.5</td>
			<td align="left">℃</td>
		</tr>
		<tr>
			<td align="right">湿度:</td>
			<td id="TEMPHUMCO2_F8_SUOZHANGSHI3_DONG_HUM" align="center" style="color: white">23.6</td>
			<td align="left">RH</td>
		</tr>
		<tr>
			<td align="right">浓度:</td>
			<td id="TEMPHUMCO2_F8_SUOZHANGSHI3_DONG_CO2" align="center" style="color: white">1225.9</td>
			<td align="left">ppm</td>
		</tr>
	</table>
</div>
<div id="TEMPHUMCO2_F8_SUOZHANGSHI3_XI" style="position: absolute; left: 350px; top: 30px;width: 100px; height: 85px; background-color: rgb(198,122,15);">
	...
	<table style="width: 100%; font-size: 12px">
		<tr>
			<td align="right">温度:</td>
			<td id="TEMPHUMCO2_F8_SUOZHANGSHI3_XI_TEMP" align="center" style="color: white">23.5</td>
			<td align="left">℃</td>
		</tr>
		<tr>
			<td align="right">湿度:</td>
			<td id="TEMPHUMCO2_F8_SUOZHANGSHI3_XI_HUM" align="center" style="color: white">23.6</td>
			<td align="left">RH</td>
		</tr>
		<tr>
			<td align="right">浓度:</td>
			<td id="TEMPHUMCO2_F8_SUOZHANGSHI3_XI_CO2" align="center" style="color: white">1225.9</td>
			<td align="left">ppm</td>
		</tr>
	</table>
</div>
...
<div id="TEMPHUMCO2_F8_ZONGJIANSHI" style="position: absolute; left: 410px; top: 120px;width: 100px; height: 85px; background-color: rgb(198,122,15);">
	...
	<table style="width: 100%; font-size: 12px">
		<tr>
			<td align="right">温度:</td>
			<td id="TEMPHUMCO2_F8_ZONGJIANSHI_TEMP" align="center" style="color: white">23.5</td>
			<td align="left">℃</td>
		</tr>
		<tr>
			<td align="right">湿度:</td>
			<td id="TEMPHUMCO2_F8_ZONGJIANSHI_HUM" align="center" style="color: white">23.6</td>
			<td align="left">RH</td>
		</tr>
		<tr>
			<td align="right">浓度:</td>
			<td id="TEMPHUMCO2_F8_ZONGJIANSHI_CO2" align="center" style="color: white">1225.9</td>
			<td align="left">ppm</td>
		</tr>
	</table>
</div>
<div id="TEMPHUMCO2_F8_HUIYISHI4" style="position: absolute; left: 510px; top: 30px;width: 100px; height: 85px; background-color: rgb(198,122,15);">
	...
	<table style="width: 100%; font-size: 12px">
		<tr>
			<td align="right">温度:</td>
			<td id="TEMPHUMCO2_F8_HUIYISHI4_TEMP" align="center" style="color: white">23.5</td>
			<td align="left">℃</td>
		</tr>
		<tr>
			<td align="right">湿度:</td>
			<td id="TEMPHUMCO2_F8_HUIYISHI4_HUM" align="center" style="color: white">23.6</td>
			<td align="left">RH</td>
		</tr>
		<tr>
			<td align="right">浓度:</td>
			<td id="TEMPHUMCO2_F8_HUIYISHI4_CO2" align="center" style="color: white">1225.9</td>
			<td align="left">ppm</td>
		</tr>
	</table>
</div>

<div id="TEMPHUMCO2_F8_XIUXIANSHI" style="position: absolute; left: 660px; top: 120px;width: 100px; height: 85px; background-color: rgb(198,122,15);">
	<div style="width: 100%; height: 30px; color: white; background-color: rgb(114,66,10); padding-top: 5px;">休闲室</div>
	<table style="width: 100%; font-size: 12px">
		<tr>
			<td align="right">温度:</td>
			<td id="TEMPHUMCO2_F8_XIUXIANSHI_TEMP" align="center" style="color: white">23.5</td>
			<td align="left">℃</td>
		</tr>
		<tr>
			<td align="right">湿度:</td>
			<td id="TEMPHUMCO2_F8_XIUXIANSHI_HUM" align="center" style="color: white">23.6</td>
			<td align="left">RH</td>
		</tr>
		<tr>
			<td align="right">浓度:</td>
			<td id="TEMPHUMCO2_F8_XIUXIANSHI_CO2" align="center" style="color: white">1225.9</td>
			<td align="left">ppm</td>
		</tr>
	</table>
</div>
...
<div id="TEMPHUMCO2_F8_SUOZHANGSHI4_DONG" style="position: absolute; left: 760px; top: 30px;width: 100px; height: 85px; background-color: rgb(198,122,15);">
	...
	<table style="width: 100%; font-size: 12px">
		<tr>
			<td align="right">温度:</td>
			<td id="TEMPHUMCO2_F8_SUOZHANGSHI4_DONG_TEMP" align="center" style="color: white">23.5</td>
			<td align="left">℃</td>
		</tr>
		<tr>
			<td align="right">湿度:</td>
			<td id="TEMPHUMCO2_F8_SUOZHANGSHI4_DONG_HUM" align="center" style="color: white">23.6</td>
			<td align="left">RH</td>
		</tr>
		<tr>
			<td align="right">浓度:</td>
			<td id="TEMPHUMCO2_F8_SUOZHANGSHI4_DONG_CO2" align="center" style="color: white">1225.9</td>
			<td align="left">ppm</td>
		</tr>
	</table>
</div>
<div id="TEMPHUMCO2_F8_SUOZHANGSHI4_XI" style="position: absolute; left: 860px; top: 30px;width: 100px; height: 85px; background-color: rgb(198,122,15);">
	...
	<table style="width: 100%; font-size: 12px">
		<tr>
			<td align="right">温度:</td>
			<td id="TEMPHUMCO2_F8_SUOZHANGSHI4_XI_TEMP" align="center" style="color: white">23.5</td>
			<td align="left">℃</td>
		</tr>
		<tr>
			<td align="right">湿度:</td>
			<td id="TEMPHUMCO2_F8_SUOZHANGSHI4_XI_HUM" align="center" style="color: white">23.6</td>
			<td align="left">RH</td>
		</tr>
		<tr>
			<td align="right">浓度:</td>
			<td id="TEMPHUMCO2_F8_SUOZHANGSHI4_XI_CO2" align="center" style="color: white">1225.9</td>
			<td align="left">ppm</td>
		</tr>
	</table>
</div>
...
<div id="TEMPHUMCO2_F8_HUIYISHI3" style="position: absolute; left: 308px; top: 500px;width: 100px; height: 85px; background-color: rgb(198,122,15);">
	...
	<table style="width: 100%; font-size: 12px">
		<tr>
			<td align="right">温度:</td>
			<td id="TEMPHUMCO2_F8_HUIYISHI3_TEMP" align="center" style="color: white">23.5</td>
			<td align="left">℃</td>
		</tr>
		<tr>
			<td align="right">湿度:</td>
			<td id="TEMPHUMCO2_F8_HUIYISHI3_HUM" align="center" style="color: white">23.6</td>
			<td align="left">RH</td>
		</tr>
		<tr>
			<td align="right">浓度:</td>
			<td id="TEMPHUMCO2_F8_HUIYISHI3_CO2" align="center" style="color: white">1225.9</td>
			<td align="left">ppm</td>
		</tr>
	</table>
</div>
<div id="TEMPHUMCO2_F8_HUIYISHI5" style="position: absolute; left: 411px; top: 500px;width: 100px; height: 85px; background-color: rgb(198,122,15);">
	...
	<table style="width: 100%; font-size: 12px">
		<tr>
			<td align="right">温度:</td>
			<td id="TEMPHUMCO2_F8_HUIYISHI5_TEMP" align="center" style="color: white">23.5</td>
			<td align="left">℃</td>
		</tr>
		<tr>
			<td align="right">湿度:</td>
			<td id="TEMPHUMCO2_F8_HUIYISHI5_HUM" align="center" style="color: white">23.6</td>
			<td align="left">RH</td>
		</tr>
		<tr>
			<td align="right">浓度:</td>
			<td id="TEMPHUMCO2_F8_HUIYISHI5_CO2" align="center" style="color: white">1225.9</td>
			<td align="left">ppm</td>
		</tr>
	</table>
</div>

<div id="TEMPHUMCO2_F8_DAHUIYISHI" style="position: absolute; left: 560px; top: 500px;width: 100px; height: 85px; background-color: rgb(198,122,15);">
	<div style="width: 100%; height: 30px; color: white; background-color: rgb(114,66,10); padding-top: 5px;">大会议室</div>
	<table style="width: 100%; font-size: 12px">
		<tr>
			<td align="right">温度:</td>
			<td id="TEMPHUMCO2_F8_DAHUIYISHI_TEMP" align="center" style="color: white">23.5</td>
			<td align="left">℃</td>
		</tr>
		<tr>
			<td align="right">湿度:</td>
			<td id="TEMPHUMCO2_F8_DAHUIYISHI_HUM" align="center" style="color: white">23.6</td>
			<td align="left">RH</td>
		</tr>
		<tr>
			<td align="right">浓度:</td>
			<td id="TEMPHUMCO2_F8_DAHUIYISHI_CO2" align="center" style="color: white">1225.9</td>
			<td align="left">ppm</td>
		</tr>
	</table>
</div>
...
<div id="TEMPHUMCO2_F8_HUIYISHI6" style="position: absolute; left: 709px; top: 500px;width: 100px; height: 85px; background-color: rgb(198,122,15);">
	...
	<table style="width: 100%; font-size: 12px">
		<tr>
			<td align="right">温度:</td>
			<td id="TEMPHUMCO2_F8_HUIYISHI6_TEMP" align="center" style="color: white">23.5</td>
			<td align="left">℃</td>
		</tr>
		<tr>
			<td align="right">湿度:</td>
			<td id="TEMPHUMCO2_F8_HUIYISHI6_HUM" align="center" style="color: white">23.6</td>
			<td align="left">RH</td>
		</tr>
		<tr>
			<td align="right">浓度:</td>
			<td id="TEMPHUMCO2_F8_HUIYISHI6_CO2" align="center" style="color: white">1225.9</td>
			<td align="left">ppm</td>
		</tr>
	</table>
</div>
<div id="TEMPHUMCO2_F8_CHUTUSHI" style="position: absolute; left: 809px; top: 500px;width: 100px; height: 85px; background-color: rgb(198,122,15);">
	...
	<table style="width: 100%; font-size: 12px">
		<tr>
			<td align="right">温度:</td>
			<td id="TEMPHUMCO2_F8_CHUTUSHI_TEMP" align="center" style="color: white">23.5</td>
			<td align="left">℃</td>
		</tr>
		<tr>
			<td align="right">湿度:</td>
			<td id="TEMPHUMCO2_F8_CHUTUSHI_HUM" align="center" style="color: white">23.6</td>
			<td align="left">RH</td>
		</tr>
		<tr>
			<td align="right">浓度:</td>
			<td id="TEMPHUMCO2_F8_CHUTUSHI_CO2" align="center" style="color: white">1225.9</td>
			<td align="left">ppm</td>
		</tr>
	</table>
</div>
